//working on legacy function, strict compile vs not with both weekend breaker and time comment
/*
...
void OnTick()
  {
   ...
   //if(!Legacy(weekend_breaker,legacy_alternative_lookback)) trade_allowed = false;
